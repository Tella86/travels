                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="operations/travellers.php" method="post"
                                ...
                                <div class="dropdown">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="val-username">State Name <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-6">
                                            <select name="state_name" class="form-control" data-toggle="dropdown"
                                                required>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-digits">Mobile <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" id="val-suggestions" name="val-suggestions"
                                            rows="5" placeholder="Enter Your Address"></textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-digits">Photo <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
