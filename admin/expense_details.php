...
<div class="popup popup--icon -question js_question-popup popup--visible">
    ...
    <div class="popup__content">
        <h3 class="popup__content__title">
            ...
            <p>
                <a href="operations/expense.php?id=<?php echo $_GET['id']; ?>" class="button button--success"
                    data-for="js_success-popup">Yes</a>
                <a href="expense_details.php" class="button button--error" data-for="js_success-popup">No</a>
            </p>
    </div>
</div>
<?php } ?>
...
<div class="page-wrapper">
  ...
  ?>
                        ...
                        <a href="add_expense.php"><button type="button" class="btn btn-primary">Add Expense</button></a>
    ...
    echo "Error: " . $e->getMessage();
        ...
        foreach ($data as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="expense_details.php?id=<?php echo $value['id']; ?>"
                                                class="btn btn-xs btn-danger"><i class="fa fa-trash fa-2x"
                                                    data-toggle="tooltip" title="Delete"></i></a>

                                            <a href="update_expense.php?id=<?php echo $value['id']; ?>"
    ...
    <div class="popup popup--icon -success js_success-popup popup--visible">
        ...
        <div class="popup__content">
            <h3 class="popup__content__title">
                ...
                <p>
                    <?php echo "<script>
  setTimeout(\"location.href='expense_details.php'\", 2000);
