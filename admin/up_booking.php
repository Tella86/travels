                        ...
                        <div class="form-validation">
                            <form action="operations/booking.php" method="post">
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-username">Travellers Name <span
...
foreach ($expense_sel as $package) { ?>
                                            <option value="<?php echo $package['id']?>">
                                                <?php echo $package['name']; $expense_sel = $package['name']; ?>
                                            </option>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-username">State<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
...
foreach ($expense_sel1 as $abc) { ?>
                                            <option value="<?php echo $abc['id']?>">
                                                <?php echo $abc['state_name']; $expense_sel1 = $abc['state_name']; ?>
                                            </option>
                                            ...
                                            <?php
                                                    foreach ($travellers as $pqr) { 
                                                      if($expense_sel1 != $pqr['state_name'])
                                                        {?>
                                            <option value="<?php echo $pqr['id']?>"><?php echo $pqr['state_name']; ?>
                                            </option>
                                            <?php 
                                                    }
                                                    } ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-username">Package Name <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
...
foreach ($success as $package) { ?>
                                            <option value="<?php echo $package['id']?>">
                                                <?php echo $package['pname']; $success = $package['pname']; ?></option>

                                            <?php
                                                    foreach ($success1 as $pack) { 
                                                      if($success != $pack['pname'])
                                                        {?>
                                            <option value="<?php echo $pack['id']?>"><?php echo $pack['pname']; ?>
                                            </option>
                                            <?php 
                                                    }
                                                    } ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">No Of Adults <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="number" min="0" onchange="calculate();" onkeyup="calculate();"
                                            class="form-control" value="<?php echo $no_of_adults;?>" id="no_of_adults"
                                            name="no_of_adults" placeholder="Enter no of adults.." required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">No Of Children <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="number" min="0" onchange="calculate();" onkeyup="calculate();"
                                            class="form-control" value="<?php echo $no_of_children;?>"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-digits">From Date<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="date" onchange="calculate();" onkeyup="calculate();"
                                            class="form-control" id="from_date" value="<?php echo $from_date;?>"
                                            name="from_date" placeholder="From Date" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-digits">To Date<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="date" onchange="calculate();" onkeyup="calculate();"
                                            value="<?php echo $to_date;?>" class="form-control" id="to_date"
                                            name="to_date" placeholder="To Date" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">Total Amount <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="total_amount" name="total_amount"
                                            placeholder="Enter Total Amount.." required readonly>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">Advance Amount<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" id="advance_amount" min="0"
                                            name="adv_amount" placeholder="Enter Advance Amount.." required>
                                    </div>
                                </div>
                                <div class="form-group row">
