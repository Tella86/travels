            ...
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="operations/travellers.php?edit_id=<?php echo $id;?>" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $name;?>"
                                                name="val-username" pattern="[a-zA-Z][a-zA-Z ]+"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $email; ?>"
                                                name="val-email" placeholder="Your valid email.." required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="txtPassword" class="form-control"
                                                name="val-password" value="" placeholder="In case to change password">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="state_name" class="form-control" required>
                                                ...
                                                <option value="Maharashtra"
                                                    <?php if($row['state_name']=="Maharashtra"){echo "selected";}?>>
                                                    Maharashtra</option>
                                                <option value="Gujrat"
                                                    <?php if($row['state_name']=="Gujrat"){echo "selected";}?>>Gujrat
                                                </option>
                                                <option value="Delhi"
                                                    <?php if($row['state_name']=="Delhi"){echo "selected";}?>>Delhi
                                                </option>
                                                <option value="Bihar"
                                                    <?php if($row['state_name']=="Bihar"){echo "selected";}?>>Bihar
                                                </option>
                                                <option value="Goa"
                                                    <?php if($row['state_name']=="Goa"){echo "selected";}?>>Goa</option>
                                                <option value="Punjab"
                                                    <?php if($row['state_name']=="Punjab"){echo "selected";}?>>Punjab
                                                </option>
                                                <option value="Assam"
                                                    <?php if($row['state_name']=="Assam"){echo "selected";}?>>Assam
                                                </option>
                                                <option value="Sikkim"
                                                    <?php if($row['state_name']=="Sikkim"){echo "selected";}?>>Sikkim
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="tel" class="form-control" value="<?php echo $mobile; ?>"
                                                name="val-digits" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$" maxlength="10"
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="update" id="btnSubmit"> <i
                                        class="fa fa-check"></i> Update</button>
                                <a href="traveller_details.php"><button type="button"
