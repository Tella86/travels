                        ...
                        <form action="operations/payment_operation.php" method="post">
                            <div class="form-body">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="booking_id"
                                                value="<?php echo $result['id'];?>" required readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" onkeyup="calculate();"
                                                name="total_amount" id="total_amount"
                                                value="<?php echo $result['total'];?>" required readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" onkeyup="calculate();"
                                                ...
                                                value="<?php echo $result6['amt'];?>" required readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" name="pending_amount"
                                                value="<?php echo $pending=$result['total']-$result6['amt'];?>" required
                                                readonly>
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="insert_amount"
                                                max="<?php echo $pending; ?>" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="add_payment.php"><button type="button"
