                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="operations/booking.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" onchange="calculate();" onkeyup="calculate();"
                                            class="form-control" id="from_date" name="from_date" placeholder="From Date"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" onchange="calculate();" onkeyup="calculate();"
                                            class="form-control" id="to_date" name="to_date" placeholder="To Date"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">Tax<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="taxprice1" name="tax"
                                            onkeyup="sum2()" placeholder="Enter Total Amount.." required>
                                    </div>
                                </div>


                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">Total<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-6">
