...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Update Package Details</h3>
        </div>
                        ...
                        <form action="operations/packages.php?edit_id=<?php echo $id;?>" method="post">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $pname;?>"
                                                name="pname" placeholder="Enter a username.."
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="price_adult"
                                                value="<?php echo $price_adult;?>" placeholder="Enter a username.."
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="price_children"
                                                value="<?php echo $price_children;?>" placeholder="Enter a username.."
                                                required>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="package_details.php"><button type="button"
