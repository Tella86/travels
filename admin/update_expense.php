...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Update Expense Details</h3>
        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" pattern="[a-zA-Z][a-zA-Z ]+"
                                                name="expense_for" value="<?php echo $expense_for;?>"
                                                placeholder="Enter a expense for.." required>
                                        </div>
                                    </div>
...
foreach ($expense_sel as $value_sel) { ?>
                                                <option value="<?php echo $value_sel['id']?>">
                                                    <?php echo $value_sel['expense_name']; $expense_sel = $value_sel['expense_name']; ?>
                                                </option>
                                                ...
                                                <option value="<?php echo $value['id']?>">
                                                    <?php echo $value['expense_name']; ?></option>
                                                <?php 
                                                    }
                                                    } ?>
                                                <?php } ?>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="<?php echo $amount;?>" class="form-control"
                                                id="val-username" name="amount" placeholder="Amount.." required>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="expense_details.php"><button type="button"
