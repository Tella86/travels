...
?>
            ...
            <div class="col-md-3">
                <div class="card p-30" style="background: #FFB64D;">
                    <div class="media">
                        <div class="media-left meida media-middle">
                            <span class="kenyan-currency">KES</span>
                        </div>
                        <div class="media-body media-text-right">
                            <?php
            ...
            <div class="card-body">
                ...
                <form class="form-valide" method="post">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="send_sms.php"><button type="submit" class="btn btn-success" name="submit"> <i
                                    class="fa fa-check"></i> Message Send</button></a>
...
try {
 ...
 foreach ($data11 as $value) {
  ...
  ?>
    ...
    <footer class="footer text-center"><strong><mark>PWANI MARINE TRAVELS | Alrights Reserved<a
                    href="ezems.developers@gmail.com   target=" _blank"
                    style="color: red;" "float:left"><?php echo "ezems.developers@gmail.com"; ?> </mark></strong>
        <?php
