...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Add Settings Details</h3>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <form class="form-valide" action="operations/update_settings.php?id=<?php echo $id;?>"
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" value="<?php echo $f_image;?>"
                                                name="f_image">
                                            <img src="../admin/settings/<?php echo $f_image;?>" width="150"
                                                height="150">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" value="<?php echo $logo_image;?>"
                                                name="logo_image">
                                            <img src="../admin/settings/<?php echo $logo_image;?>" width="150"
                                                height="150">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" value="<?php echo $login_image;?>"
                                                name="login_image">
                                            <img src="../admin/settings/<?php echo $login_image;?>" width="150"
                                                height="150">
                                ...
                                <div class="row p-t-20">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="currency" class="form-control" required>
                                                ...
                                                <option value="<?php echo $value['id']?>"
                                                    <?php if($value['id']==$currency){ echo "selected"; } ?>>
                                                    <?php echo $value['curr_symbol']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="val-username"
                                                value="<?php echo $footer;?>" name="footer">
                                        </div>
                                    </div>
