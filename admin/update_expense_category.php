...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Update Expense Category Details</h3>
        </div>
                        ...
                        <form action="operations/expense_category.php?edit_id=<?php echo $id;?>" method="post">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $expense_name;?>"
                                                pattern="[a-zA-Z][a-zA-Z ]+" name="expense_name"
                                                placeholder="Enter a Expense Name..">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="status" value="Active"
                                                <?php if($row['status']=="Active"){echo "checked";}?>> Active
                                            &nbsp; &nbsp;&nbsp;<input type="radio" name="status" value="Deactive"
                                                <?php if($row['status']=="Deactive"){echo "checked";}?>>Deactive<br>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="expense_category_details.php"><button type="button"
