...
<div class="popup popup--icon -question js_question-popup popup--visible">
    ...
    <div class="popup__content">
        <h3 class="popup__content__title">
            ...
            <p>
                <a href="operations/approve_delete.php?id=<?php echo $_GET['id']; ?>" class="button button--success"
...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Activated User Details</h3>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="disapprove_user.php?id=<?php echo $value['id']; ?>"
                                                class="btn btn-xs btn-info"><i class="fa fa-thumbs-down fa-2x"
