        ...
        $stmt6 = $conn->prepare("SELECT SUM(insert_amount) as amt from payment where booking_id='".$value['id']."'"); 
                ...
                $result6=$stmt6->fetch(PDO::FETCH_ASSOC);
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:5px"><?php echo $value['total'];?></td>
                                        <td style="width:5px"><?php echo $result6['amt'];?></td>

                                        <td><a href="booking_details.php?id=<?php echo $value['id']; ?>"
                                            ...
                                            <a href="practice_pdf.php?id=<?php echo $value['id']; ?>"
                                                class="btn btn-xs btn-success"><i class="fa fa-file-pdf-o"
