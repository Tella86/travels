...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Add Email Settings</h3>
        </div>
                        ...
                        <form method="post">
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mail_driver_host"
                                                value="<?php echo $mail_driver_host;?>" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mail_port" value="<?php echo $mail_port;?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="mail_username"
                                                value="<?php echo $mail_username;?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="mail_password"
                                                value="<?php echo $mail_password;?>" class="form-control">
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="email_setup.php"><button type="button"
