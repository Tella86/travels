...
foreach ($expense_sel as $package) { ?>
                                        ...
                                        <div class="form-group has-danger">
                                            ...
                                            <select name="state_name" class="form-control" required>
                                                ...
                                                <option value="Maharashtra"
                                                    <?php if($row['state_id']=="Maharashtra"){echo "selected";}?>>
                                                    Maharashtra</option>
                                                <option value="Gujrat"
                                                    <?php if($row['state_id']=="Gujrat"){echo "selected";}?>>Gujrat
                                                </option>
                                                <option value="Delhi"
                                                    <?php if($row['state_id']=="Delhi"){echo "selected";}?>>Delhi
                                                </option>
                                                <option value="Bihar"
                                                    <?php if($row['state_id']=="Bihar"){echo "selected";}?>>Bihar
                                                </option>
                                                <option value="Goa"
                                                    <?php if($row['state_id']=="Goa"){echo "selected";}?>>Goa</option>
                                                <option value="Punjab"
                                                    <?php if($row['state_id']=="Punjab"){echo "selected";}?>>Punjab
                                                </option>
                                                <option value="Assam"
                                                    <?php if($row['state_id']=="Assam"){echo "selected";}?>>Assam
                                                </option>
                                                <option value="Sikkim"
                                                    <?php if($row['state_id']=="Sikkim"){echo "selected";}?>>Sikkim
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="package_id" id="package_id" onchange="calculate();"
                                                ...
                                                <option
                                                    ...
                                                    <?php if($value['id']==$package_id){ echo "selected"; } ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="date" onchange="calculate();" onkeyup="calculate();"
                                                ...
                                                value="<?php echo $from_date;?>" placeholder="From Date" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="date" onchange="calculate();" onkeyup="calculate();"
                                                ...
                                                value="<?php echo $to_date;?>" placeholder="To Date" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" id="taxprice1"
                                                value="<?php echo $tax;?>" name="tax" onkeyup="sum2()"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" class="form-control" id="advance_amount"
                                                value="<?php echo $adv_amount;?>" name="tax" min="0"
                                                max="<?php echo $total; ?>" name="adv_amount"
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="my_booking.php"><button type="button"
