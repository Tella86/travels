...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Finance Details</h3>
        </div>
       ...
       $stmt6 = $conn->prepare("SELECT SUM(insert_amount) as amt from payment where booking_id='".$value['id']."'"); 
                ...
                $result6=$stmt6->fetch(PDO::FETCH_ASSOC);
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:5px"><?php echo $currency["curr_symbol"].' '.$value['total'];?>
                                        </td>

                                        <td style="width: 15px">
                                            <?php echo $currency["curr_symbol"].' '. $result6['amt'];?></td>

                                        <td style="width: 15px"><?php  echo $currency["curr_symbol"]?>
                                            <?php echo $value['total']-$result6['amt'];?>
                          ...
                          if ($value['total']==$result6['amt'])
                                        ...
                                        <td>
                                            ...
                                            <a href="add_payment.php?id=<?php echo $value['id']; ?>"
                                                ...
                                                style="width: 40px; margin-right: 20px"><i class="fa fa-inr fa-2x"
                                                    data-toggle="tooltip" title="Make Payment"></i></a>
