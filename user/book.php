                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="user_operations/booking.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="state_id" onchange="tax();" class="form-control" required>
                                            ...
                                            <?php
                                                    foreach ($travellers as $value) { ?>
                                            <option value="<?php echo $value['id'].','.$value['state_name']?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" min="0" onchange="calculate();" onkeyup="calculate();"
                                            ...
                                            value="<?php echo $no_of_adults;?>" placeholder="Enter no of adults.."
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" min="0" onchange="calculate();" onkeyup="calculate();"
                                            ...
                                            value="<?php echo $no_of_children;?>" placeholder="Enter No of Children.."
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" onchange="calculate();" onkeyup="calculate();"
                                            class="form-control" id="to_date" value="<?php echo $to_date;?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="total_amount"
                                            value="<?php echo $total_amount;?>" name="total_amount"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" id="advance_amount"
                                            value="<?php echo $adv_amount;?>" min="0" name="adv_amount"
