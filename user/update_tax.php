                        ...
                        <form action="operations/tax.php?edit_id=<?php echo $id;?>" method="post">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" pattern="[a-zA-Z][a-zA-Z ]+"
                                                ...
                                                placeholder="Enter a tax name.." required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="percent"
                                                value="<?php echo $percent;?>" placeholder="Percentage" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="short_code"
                                                value="<?php echo $short_code;?>" placeholder="Short code" required>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="tax_details.php"><button type="button"
