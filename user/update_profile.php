...
<div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-primary">
                    ...
                    <div class="card-body">
                        <form method="post" action="user_operations/profile.php?id=<?php echo $id;?>"
                                        ...
                                        <div class="form-group has-danger">
                                            ...
                                            <select name="state_name" class="form-control custom-select" required>
                                                ...
                                                <option value="<?php echo $value['state_name']?>"
                                                    <?php if($value['state_name']==$state_name){ echo "selected"; } ?>>
 ...
 for any PHP, Codeignitor or Laravel work contact me at mayuri.infospace@gmail.com  -->
                                <button type="submit" class="btn btn-success" name="update"> <i class="fa fa-check"></i>
                                    Update</button>
                                <a href="update_profile.php"><button type="button"
